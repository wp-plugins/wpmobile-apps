...
error_reporting(0);
if (!class_exists('acera_theme_options_now')) {

    class acera_theme_options_now {

        private $options;

        public function acera_theme_options_now($options) {
        ...
        public function acera_add_menu() {
            #add_menu_page('Now Options', 'Now Options', 'manage_options', 'acera_options_now_options', array(&$this, 'acera_display_page'));
        }
